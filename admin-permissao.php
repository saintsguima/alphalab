...
<body>
                                ...
                                <form class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt01"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt02"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0201"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0202"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0203"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt03"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0301"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0302"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0303"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt04"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0401"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0402"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0403"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:60px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt040301"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:60px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt040302"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0404"
                                                checked="">
                                            <label class="form-check-label" for="swt0404">0404 - Exceção</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0405"
                                                checked="">
                                            <label class="form-check-label" for="swt0405">0405 - Plano</label>
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt05"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0501"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0502"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0503"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0504"
                                                checked="">
                                            <label class="form-check-label" for="swt0504">0504 - Ajuste</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt06"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0601"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0602"
                                                checked="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0603"
                                                checked="">
                                            <label class="form-check-label" for="swt0603">0603 - Não
                                                Identificados</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0604"
                                                checked="">
                                            <label class="form-check-label" for="swt0603">0604 - Fazer
                                                Conciliação</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check form-switch" style="margin-left:30px">
                                            <input class="form-check-input" type="checkbox" role="switch" id="swt0605"
                                                checked="">
                                            <label class="form-check-label" for="swt0603">0605 - Conciliação
                                                Direta</label>
                                        </div>
                                    </div>
                                </form>
    ...
    <script src="assets/js/pages/admin-permissao.js?v=5"></script>
