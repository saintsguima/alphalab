<?php
	...
	if ($_SESSION['perfil_permissoes']['0202'] == 0){
					...
					<div class="main-body">
                        <div class="card">
							<div class="card-body p-4">
								<h5 class="mb-4">Admin - Perfil</h5>
								<form class="row g-3">
									<input type="hidden" id="hdnAcao" name="hdnAcao" value="<?= $_GET["acao"]?>"/>
									<input type="hidden" id="hdnAdminPerfilId" name="hdnAdminPerfilId" value="<?= $_GET["perfilId"] ?? ''?>"/>
