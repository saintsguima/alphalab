<?php
    ...
    if ($_SESSION['perfil_permissoes']['0503'] == 0) {
...
<body>
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Erro de Carga</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="dtCRErro" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Arquivo</th>
                                                <th>Linha Inconsistente</th>
                                                <th>CPF / CNPJ</th>
                                                <th>Valor</th>
                                                <th>Motivo</th>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <label for="txtWhatDelete" class="form-label">Excluir Arquivo com ?</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-text"><i class='bx bx-trash'></i></div>
                                            <input type="text" class="form-control" id="txtWhatDelete"
                                                name="txtWhatDelete" placeholder="O que Deletar ?" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-md-flex d-grid align-items-center gap-3"
                                            style="padding-top:30px;">
                                            <button type="button" id="cmdExcluirArquivo" onclick="excluirErroEmLote()" ;
                                                class="btn btn-primary px-4">Excluir</button>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php
        include "foot.php";
    ?>
    <script src="assets/js/pages/list-cr-erro.js?v=0"></script>
