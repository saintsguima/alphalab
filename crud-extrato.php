                    ...
                    <div class="main-body">
                        <div class="card">
                            <div class="card-body p-4">
                                <h5 class="mb-4">Arquivo de Extratos</h5>
                                <form class="row g-3"
                                    action="<?php echo $GLOBALS['HOST'] . $GLOBALS['APP_HOST']; ?>upload-extrato.php"
                                    ...
                                    <div class="col-md-6">
                                        <label for="ddlBanco" class="form-label">Banco</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-text"><i class='bx bx-buildings'></i></div>
                                            <select class="form-control" id="ddlBanco" name="ddlBanco">
                                                <option value="341I">Itaú Conta 19571-1</option>
                                                <option value="341II">Itaú Conta 99839-5 (Boleto)</option>
                                                <option value="341III">Itaú Conta 99839-5</option>
