<?php
    ...
    if ($_SESSION['perfil_permissoes']['0402'] == 0) {
...
<body>
                    ...
                    <div class="main-body">
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <form class="row g-3">
                                    <input type="hidden" id="hdnAcao" name="hdnAcao" value="<?php echo $_GET["acao"]?>" />
                                    <input type="hidden" id="hdnClienteId" name="hdnClienteId"
                                        value="<?php echo $_GET["clienteId"] ?? ''?>" />
                                    ...
                                    <div class="col-md-6">
                                        <label for="txCPF" class="form-label">CPF / CNPJ</label>
                                        <div class="position-relative input-icon">
                                            <input type="text" class="form-control" id="txtCPF" name="txtCPF"
                                                placeholder="CPF / CNPJ" data-type="cpfcnpj">
                                            <span class="position-absolute top-50 translate-middle-y"><i
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="position-relative input-icon">
                                            <input type="text" class="form-control" id="txtTelefone" name="txtTelefone"
                                                placeholder="Telefone" data-type="telefone" data-type="telefone">
                                            <span class="position-absolute top-50 translate-middle-y"><i
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="chkEnvioWhatsapp"
                                                name="chkEnvioWhatsapp">
                                            <label class="form-check-label" for="chkEnvioWhatsapp">Envio de Whatsapp de
                                                Cobrança</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="chkEnvioEmail"
                                                name="chkEnvioEmail">
                                            <label class="form-check-label" for="chkEnvioEmail">Envio de Email de
                                                Cobrança</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="chkAtivo"
                                                name="chkAtivo">
    ...
    <script src="assets/js/pages/crud-cliente.js?v=1"></script>
