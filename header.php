			...
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand gap-3">
					<div class="mobile-toggle-menu"><i class='bx bx-menu'></i>
					  ...
					  <div class="position-relative search-bar d-lg-block d-none" data-bs-toggle="modal" data-bs-target="#SearchModal" style="display:none !important">
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="index.html#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info">
								<p class="user-name mb-0"><?php echo $_SESSION["NOME"];?></p>
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item d-flex align-items-center" href="<?php echo $GLOBALS["HOST"] . $GLOBALS["APP_HOST"]?>"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
